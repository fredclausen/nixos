...
in
{
  ...
  config = lib.mkIf cfg.enable {
    home-manager.users.${username} = {
      # 1) Declare the Thunderbird profile
      ...
      home.activation.thunderbirdSignatureFiles = lib.mkAfter ''
      ...
      home.activation.thunderbirdSignaturePrefs = lib.mkAfter ''
