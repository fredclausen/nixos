    ...
    -- https://www.lazyvim.org/plugins/extras/coding.copilot
    {
      ...
      opts = function(_, opts)
        local Util = require("lazyvim.util")
          ...
          Snacks.util.color("Normal", "Special")
          Snacks.util.color("Warning", "DiagnosticError")
          Snacks.util.color("InProgress", "DiagnosticWarn")
        ...
        table.insert(opts.sections.lualine_x, 2, {
          ...
          color = function()
            ...
            local status = require("copilot.api").status.data
            return Snacks.util.color(status.status, "Special")
